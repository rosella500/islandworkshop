...
with open("craft_peaks.csv",'w', newline='') as csvfile:
    ...
    for i in range(59,1059):
        random.shuffle(peaks62)
        random.shuffle(peaks63)
        random.shuffle(peaks64)
        random.shuffle(peaks65)
        peaks=peaks62+peaks63+peaks64+peaks65
